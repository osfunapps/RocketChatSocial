...
public class MessagesListAdapter<MESSAGE extends IMessage>
    ...
    public MessagesListAdapter(String myUserId) {
        this.senderId = myUserId;
        this.holders = setHolders();
        this.imageLoader = null;
        this.items = new ArrayList<>();
    }

    private MessageHolders setHolders() {
        return new MessageHolders()
                .setIncomingTextLayout(com.osapps.chat.R.layout.item_message)
                .setOutcomingTextLayout(com.osapps.chat.R.layout.item_message);
    ...
    * */
    ...
    public static class DefaultDateHeaderViewHolder extends ViewHolder<Date>
        ...
        public DefaultDateHeaderViewHolder(View itemView) {
            super(itemView);
            dateTV = (TextView) itemView.findViewById(R.id.messageText);
        }
        ...
        public void onBind(Date date) {
            if (dateTV != null) {
                ...
                dateTV.setText(formattedDate == null ? DateFormatter.format(date, dateFormat) : formattedDate);
            }
        }
...
//            if (dateTV != null) {
//                dateTV.setTextColor(style.getDateHeaderTextColor());
//                dateTV.setTextSize(TypedValue.COMPLEX_UNIT_PX, style.getDateHeaderTextSize());
//                dateTV.setTypeface(dateTV.getTypeface(), style.getDateHeaderTextStyle());
//                dateTV.setPadding(style.getDateHeaderPadding(), style.getDateHeaderPadding(),
