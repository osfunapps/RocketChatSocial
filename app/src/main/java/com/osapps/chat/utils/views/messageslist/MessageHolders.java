...
public class MessageHolders {
    ...
    * */
    ...
    public static class OutcomingTextMessageViewHolder<MESSAGE extends IMessage>
        ...
        protected ConstraintLayout bubble;
...
//
//            if (content != null) {
//                content.setTextColor(style.getOutcomingTextColor());
//                content.setTextSize(TypedValue.COMPLEX_UNIT_PX, style.getOutcomingTextSize());
//                content.setTypeface(content.getTypeface(), style.getOutcomingTextStyle());
//                content.setAutoLinkMask(style.getTextAutoLinkMask());
//                content.setLinkTextColor(style.getOutcomingTextLinkColor());
//                configureLinksBehavior(content);
//            }
        }
    }
